...
//
// In v1 the migration table is empty — the format starts at version 1, so
// there is nothing older to lift forward yet. The module exists as the
// structural commitment from ADR-0016: when v2 ships, a `1 → 2` entry lands
// here and the parser keeps working without any other plumbing changes.
